...
class GoogleDrive(private val tokenDirectory: String = TOKENS_DIRECTORY_PATH) {
    ...
    constructor(clientId: String?, clientSecret: String?, tokenDirectory: String = TOKENS_DIRECTORY_PATH) : this(
        tokenDirectory
    ) {
    ...
    companion object {
        private const val APPLICATION_NAME = "Gradle .NET Wording Plugin"
